...
printSome("Deaths: ",centerX-42,centerY+45);
...
if(MenuFlag == 1)
{
    ...
    if(scoreflag == 1)
    {
        printSome("Game Over: ",centerX-15,centerY+45);
    }
    if(alphaY > 90)
    {
       printSome("You Win!!! ",centerX-15,centerY+45); 
    }
...
//g++ Game.cpp -o Game -lglut -lGLU -lGL
...
glutReshapeFunc(reshape);//Problem with this line   <<--- Remove this and press where the start button is
    glutMouseFunc(mouse);
